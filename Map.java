public class Map {
    ...
    private void createRooms() {
        Room room1 = new Room(
                ...
                "You see the letter 'T' shining brightly on the ground, illuminating your path."
        );
        Room room2 = new Room(
                ...
                "You notice a letter 'E' glowing faintly, waiting to be discovered."
        );
        ...
        Room room3 = new Room(
                ...
                "A letter 'R' lies on a dusty shelf, catching your eye."
        );
        ...
        Room room4 = new Room(
                ...
                "A shimmering letter 'D' floats just beneath the surface of the water."
        );
        ...
        Room room7 = new Room(
                ...
                "A letter 'V' is tucked between the pages of an ancient book."
        );
        ...
        Room room9 = new Room(
                ...
                "A letter 'I' rests on the pedestal, radiating light."
        );
        ...
        connectRooms(room1, "east", room2);
        connectRooms(room1, "south", room4);
        connectRooms(room2, "east", room3);
        connectRooms(room3, "south", room6);
        connectRooms(room4, "south", room7);
        connectRooms(room5, "south", room8);
        connectRooms(room6, "south", room9);
        connectRooms(room7, "east", room8);
        connectRooms(room8, "east", room9);
